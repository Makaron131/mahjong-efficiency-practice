            ...
            <div className="flex items-center gap-2">
              {showNext && (
                <button
                  type="button"
                  onClick={onNext}
                  className="rounded-full bg-slate-900 px-4 py-1.5 text-xs font-semibold text-white shadow"
                >
                  下一题
                </button>
              )}
              <button
                type="button"
                onClick={onClose}
                className="rounded-full border border-rose-200 px-3 py-1.5 text-xs font-semibold text-rose-600 hover:border-rose-300 hover:text-rose-700"
              >
                关闭
              </button>
            </div>
